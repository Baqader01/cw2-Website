...
class __TwigTemplate_c31e2bf2b014c9b3f3f8eaac7acb62d7 extends Template
{
    ...
    <div class=\"title\">
        ...
        <ul>
            <li><a href=\"/website\">Our Story</a></li>
            <li><a href=\"/website/shifts\">Shifts</a></li>

            ";
        // line 14
        if ((($tmp = ($context["isVolunteer"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 15
            yield "                <li><a href=\"/website/shifts/myShifts\">My Shifts</a></li>
...
($context["isStaff"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 19
            yield "                <li><a href=\"/website/volunteers\">View volunteers</a></li>
                <li><a href=\"/website/logout\">Logout</a></li>

            ";
        } else {
            // line 23
            yield "                <li><a href=\"/website/login\">Login</a></li>
            ";
        }
        // line 25
        yield "            </ul>
    ...
    <div class=\"title\">
        ...
        <ul>
            ...
            {% if isVolunteer %}
                <li><a href=\"/website/shifts/myShifts\">My Shifts</a></li>
                <li><a href=\"/website/logout\">Logout</a></li>
            
            {% elseif isStaff %}
                <li><a href=\"/website/volunteers\">View volunteers</a></li>
                <li><a href=\"/website/logout\">Logout</a></li>
