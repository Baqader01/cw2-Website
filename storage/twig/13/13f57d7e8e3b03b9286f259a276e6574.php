...
";
    ...
    public function block_scripts(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 66
        yield "  <script src=\"/website/assets/js/auth.js\"></script>
";
        yield from [];
    }
...
{% block scripts %}
  <script src=\"/website/assets/js/auth.js\"></script>
{% endblock %}
", "auth/login.twig", "/var/www/html/website/src/Views/auth/login.twig");
    }
}
